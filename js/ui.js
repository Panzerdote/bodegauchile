...
const UI = {
    ...
    setConnectionStatus(emoji, text) {
        ...
        if (el) {
            const color = emoji === 'success' ? '#27ae60' : emoji === 'warning' ? '#f39c12' : '#c0392b';
            el.innerHTML = `<svg viewBox="0 0 24 24" width="12" height="12" fill="${color}" style="vertical-align:middle;"><circle cx="12" cy="12" r="6"/></svg> ${text}`;
        }
    },
